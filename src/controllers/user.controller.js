...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const coverImageLocalPath = req.files?.files[0]?.path;
  ...
  if (!avatar) throw new ApiError(400, "Avatar filed is required");
  ...
  if (createdUser)
    throw new ApiError(500, "Something went wrong whle creating user");
